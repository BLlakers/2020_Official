...
public final class Constants {
    ...
    public static final int rightSideTargetDistance = 132432;
    ...
    public static final double BBTurretSpinSpeed = 0.1; //TODO: Adjust Bang Bang speed
    ...
    public static final Gains kGains_Velocity = new Gains( 0.6, 0.00225, 10, 1023/7200,  300,  1.00);//
    //-------------------COLOR WHEEL------------------//
    ...
    public static final double winchRaiseDistance = 45200;
    public static final double winchLowerDistance = 82000;//73200
    //-------------------PNEUMATICS-------------------//
